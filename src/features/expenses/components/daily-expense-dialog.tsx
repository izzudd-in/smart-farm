...
export function DailyExpenseDialog({
  ...
  const [
    ...
    useState<DailyExpenseCategoryValue>(
      expense?.category ??
        "OTHER",
    );
        ...
        <header className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-border bg-white p-5">
          <div>
            ...
            <p className="mt-1 text-sm text-muted">
              Form ini hanya untuk pengeluaran yang dicatat Owner.
            </p>
          </div>
        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              rows={4}
              maxLength={1000}
              placeholder="Contoh: transport pengambilan obat"
              value={
                description
              }
              disabled={
